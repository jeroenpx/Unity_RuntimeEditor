...
![Screenshot](img/vtv/overview/vtv.png)

##Getting Started

 1. Create Canvas.
 2. Add __VirtualizingTreeView.prefab__ from   
   __Assets/Battlehub/UIControls/VirtualizingTreeView/Prefabs__ to hierarchy.
...
![Screenshot](img/vtv/get-started/get-started.png)

!!! note

      Full demo can be found in  __Assets/Battelhub/UIControls/VirtualizingTreeView/Demo__ folder

##Virtualizing Scroll Rect

This class reuses "ui containers" to efficiently represent large collections of data elements. UI containers are created for a small visible part of the data elements. 
__VirtualizingScrollRect.cs__ can be found in __Assets/Battlehub/UIControls/VirtualizingTreeView/Scripts/__ folder.
...
![Screenshot](img/vtv/item-drop-marker/item-drop-marker.png)

##Virtualizing Tree View

Structure:

![Screenshot](img/vtv/vtv/structure.png)

Prefab: __Assets/Battelhub/UIControls/VirtualizingTreeView/Prefabs/VirtualizingTreeView.prefab__.
Script: __Assets/Battelhub/UIControls/VirtualizingTreeView/Scripts/VirtualizingTreeView.cs__.  
...
!!! note
      ...
      ExampleDataItem is defined in [Getting Started](#getting-started) section.
...
![Screenshot](img/vtv/vtv-item/structure.png)


Prefab: __Battelhub/UIControls/VirtualizingTreeView/Prefabs/VirtualizingTreeViewItem.prefab__.
Script: __Battelhub/UIControls/VirtualizingTreeView/Scripts/VirtualizingTreeViewItem.cs__.  
