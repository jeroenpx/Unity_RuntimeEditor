...
{
    [ProtoContract]
    public partial class PersistentParticleSystemNestedCollisionModule : PersistentSurrogate
    {
        [ProtoMember(256)]
        public bool enabled;
        ...
        [ProtoMember(259)]
        public PersistentParticleSystemNestedMinMaxCurve dampen;

        [ProtoMember(260)]
        public float dampenMultiplier;

        [ProtoMember(261)]
        public PersistentParticleSystemNestedMinMaxCurve bounce;

        [ProtoMember(262)]
        public float bounceMultiplier;

        [ProtoMember(263)]
        public PersistentParticleSystemNestedMinMaxCurve lifetimeLoss;
        ...
        [ProtoMember(267)]
        public PersistentLayerMask collidesWith;
