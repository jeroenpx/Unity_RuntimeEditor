...
{
    [ProtoContract]
    public partial class PersistentParticleSystemNestedLightsModule : PersistentSurrogate
    {
        [ProtoMember(256)]
        public bool enabled;
        ...
        [ProtoMember(263)]
        public PersistentParticleSystemNestedMinMaxCurve range;

        [ProtoMember(264)]
        public float rangeMultiplier;

        [ProtoMember(265)]
        public PersistentParticleSystemNestedMinMaxCurve intensity;
