...
{
    [ProtoContract]
    public partial class PersistentParticleSystemNestedTrailModule : PersistentSurrogate
    {
        [ProtoMember(256)]
        public bool enabled;
        ...
        [ProtoMember(259)]
        public PersistentParticleSystemNestedMinMaxCurve lifetime;
        ...
        [ProtoMember(268)]
        public PersistentParticleSystemNestedMinMaxGradient colorOverLifetime;

        [ProtoMember(269)]
        public PersistentParticleSystemNestedMinMaxCurve widthOverTrail;

        [ProtoMember(270)]
        public float widthOverTrailMultiplier;

        [ProtoMember(271)]
        public PersistentParticleSystemNestedMinMaxGradient colorOverTrail;
