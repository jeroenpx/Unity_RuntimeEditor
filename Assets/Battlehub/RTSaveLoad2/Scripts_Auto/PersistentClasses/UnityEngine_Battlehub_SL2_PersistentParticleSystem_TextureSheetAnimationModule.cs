...
{
    [ProtoContract]
    public partial class PersistentParticleSystemNestedTextureSheetAnimationModule : PersistentSurrogate
    {
        [ProtoMember(256)]
        public bool enabled;
        ...
        [ProtoMember(262)]
        public PersistentParticleSystemNestedMinMaxCurve frameOverTime;

        [ProtoMember(263)]
        public float frameOverTimeMultiplier;

        [ProtoMember(264)]
        public PersistentParticleSystemNestedMinMaxCurve startFrame;
        ...
        [ProtoMember(273)]
        public PersistentVector2 speedRange;
