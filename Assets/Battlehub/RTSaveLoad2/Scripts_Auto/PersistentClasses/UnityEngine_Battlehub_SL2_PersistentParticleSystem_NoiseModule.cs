...
{
    [ProtoContract]
    public partial class PersistentParticleSystemNestedNoiseModule : PersistentSurrogate
    {
        [ProtoMember(256)]
        public bool enabled;
        ...
        [ProtoMember(258)]
        public PersistentParticleSystemNestedMinMaxCurve strength;

        [ProtoMember(259)]
        public float strengthMultiplier;

        [ProtoMember(260)]
        public PersistentParticleSystemNestedMinMaxCurve strengthX;

        [ProtoMember(261)]
        public float strengthXMultiplier;

        [ProtoMember(262)]
        public PersistentParticleSystemNestedMinMaxCurve strengthY;

        [ProtoMember(263)]
        public float strengthYMultiplier;

        [ProtoMember(264)]
        public PersistentParticleSystemNestedMinMaxCurve strengthZ;
        ...
        [ProtoMember(272)]
        public PersistentParticleSystemNestedMinMaxCurve scrollSpeed;
        ...
        [ProtoMember(275)]
        public PersistentParticleSystemNestedMinMaxCurve remap;

        [ProtoMember(276)]
        public float remapMultiplier;

        [ProtoMember(277)]
        public PersistentParticleSystemNestedMinMaxCurve remapX;

        [ProtoMember(278)]
        public float remapXMultiplier;

        [ProtoMember(279)]
        public PersistentParticleSystemNestedMinMaxCurve remapY;

        [ProtoMember(280)]
        public float remapYMultiplier;

        [ProtoMember(281)]
        public PersistentParticleSystemNestedMinMaxCurve remapZ;

        [ProtoMember(282)]
        public float remapZMultiplier;

        [ProtoMember(283)]
        public PersistentParticleSystemNestedMinMaxCurve positionAmount;

        [ProtoMember(284)]
        public PersistentParticleSystemNestedMinMaxCurve rotationAmount;

        [ProtoMember(285)]
        public PersistentParticleSystemNestedMinMaxCurve sizeAmount;
