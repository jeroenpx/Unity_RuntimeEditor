...
{
    [ProtoContract]
    public partial class PersistentParticleSystemNestedVelocityOverLifetimeModule : PersistentSurrogate
    {
        [ProtoMember(256)]
        public bool enabled;
        ...
        [ProtoMember(263)]
        public PersistentParticleSystemNestedMinMaxCurve orbitalX;

        [ProtoMember(264)]
        public PersistentParticleSystemNestedMinMaxCurve orbitalY;

        [ProtoMember(265)]
        public PersistentParticleSystemNestedMinMaxCurve orbitalZ;
        ...
        [ProtoMember(269)]
        public PersistentParticleSystemNestedMinMaxCurve orbitalOffsetX;

        [ProtoMember(270)]
        public PersistentParticleSystemNestedMinMaxCurve orbitalOffsetY;

        [ProtoMember(271)]
        public PersistentParticleSystemNestedMinMaxCurve orbitalOffsetZ;
        ...
        [ProtoMember(275)]
        public PersistentParticleSystemNestedMinMaxCurve radial;

        [ProtoMember(276)]
        public float radialMultiplier;

        [ProtoMember(277)]
        public PersistentParticleSystemNestedMinMaxCurve speedModifier;
