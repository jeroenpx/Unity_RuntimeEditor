...
namespace Battlehub.RTTerrain
{
    ...
    public class TerrainSelectionHandlesTool : EditorOverride, ITerrainSelectionHandlesTool
    {
        ...
        private void InitHandles()
        {
            ...
            m_keyToHandle = new Dictionary<int, GameObject>(m_state.Grid.Length);
            ...
            for (int x = 0; x < xCount; ++x)
            {
                for (int z = 0; z < zCount; ++z)
                {
                    ...
                    m_keyToHandle.Add(key, handle.gameObject);
                }
            }
        }
        ...
        private void OnDrop(BaseHandle handle)
        {
            if (m_isDragging)
            {
                ...
                if (m_selectedHandles != null)
                {
                    ...
                    {
                        GameObject selectedHandle = m_keyToHandle[selectedHandles[i]];
