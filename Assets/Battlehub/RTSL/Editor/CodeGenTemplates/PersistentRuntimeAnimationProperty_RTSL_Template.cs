...
{
    using PersistentRuntimeAnimationProperty = PersistentSurrogateTemplate;
    ...
    public class PersistentRuntimeAnimationProperty_RTSL_Template : PersistentSurrogateTemplate
    {
        ...
        public override void ReadFrom(object obj)
        {
            ...
            {
                Children = new List<PersistentRuntimeAnimationProperty>();
                for(int i = 0; i < property.Children.Count; ++i)
                {
                    PersistentRuntimeAnimationProperty persistentChildProperty = new PersistentRuntimeAnimationProperty();
            ...
            {
                Curve = new PersistentAnimationCurve();
