...
namespace Battlehub.RTSL.Internal
{
    ...
    public class PersistentRuntimeAnimationClip_RTSL_Template : PersistentSurrogateTemplate
    {
        ...
        [ProtoMember(1)]
        public PersistentRuntimeAnimationProperty[] Properties;
        ...
        public override void ReadFrom(object obj)
        {
            ...
            {
                int index = 0;
                Properties = new PersistentRuntimeAnimationProperty[properties.Count];
                foreach(RuntimeAnimationProperty property in properties)
                {
                    Properties[index] = new PersistentRuntimeAnimationProperty();
